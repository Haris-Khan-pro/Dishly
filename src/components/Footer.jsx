    ...
    <footer className="px-auto relative mt-44 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-6 justify-between pb-8">
            ...
            <div className="flex items-center gap-1.5 mt-6">
              {socialLinks.map((item, index) => (
                <Animated key={index} delay={index * 0.05}>
                  <a
                    href={item.href}
                    className="size-7.5 rounded-l-full border border-slate-300 grid place-content-center"
                  >
                    {item.icon}
                  </a>
                </Animated>
          ...
          {/* Coloum 3 - Get in Touch */}
          <div>
            <p className="font-medium mb-5">Get in Touch</p>
            <div className="space-y-2">
              <Animated>
                <a
                  href="mailto:hash@example.com"
        ...
        {/* Bottom Bar */}
        <div className="border-t text-zinc-500 border-slate-200 py-4.5 flex justify-center items-center">
